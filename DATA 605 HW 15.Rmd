...
I will be using this tutorial to build a regrssion line by hand;
...
I will do the calculations using r. 
...
We need to subtract the mean of y from each data point in y. We do not need to square that result since that is not in the formula required for deriving regression. We will also go ahead and take the product of the differences between x-x mean and y-y mean
```{r}
ydiff = y-y_mean
